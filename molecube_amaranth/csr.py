...
class Registers(Elaboratable):
    ...
    def __init__(self, config):
        ...
        self.ttl_in = Signal(self.REG_WIDTH)
        self.ttl_io_in = Signal(self.REG_WIDTH)
        self.ttl_io_out = Signal(self.REG_WIDTH)
        self.ttl_io_oe = Signal(self.REG_WIDTH, init=2**self.REG_WIDTH - 1)
